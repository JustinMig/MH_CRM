...
function moveAddClientToTop() {
  ...
  pageButton.title = 'New Client';
  pageButton.setAttribute('aria-label', 'New Client');
  pageButton.setAttribute('aria-haspopup', 'dialog');
  pageButton.innerHTML = '<span class="tool-icon tool-client"><svg viewBox="0 0 24 24" aria-hidden="true"><circle cx="12" cy="8" r="4"/><path d="M4 21v-2a8 8 0 0 1 13.2-6.1M19 14v6M16 17h6"/></svg></span><strong>New Client</strong>';
